...
<body>
	...
	<!-- LIST POSTS -->
    <section id="users-list-section" class="mt-4">
    	<div class="container">
    		<div class="row">
    			<div class="col-md-9">
    				<div class="card">
    					<div class="card-body m-1">
    						<table id="all-users-table" class="table table-hover table-light">
		    					...
		    					<tbody>
		    						<c:forEach var="tempUser" items="${ allUsers }">
		    							<tr class='clickable-row' data-href='view-user?username=${tempUser.username}'>
